        ...
        <section class="Main-Contain">
            <div class="container">
                <div class="row">
                  <div class="col-md-9">
                        <?php
                            foreach ($Post->readALLFor($start_page,$per_page) as $key => $value){
                        ?>
                      ...
                      <div class="media">
                        ...
                        <a href="#">
                          ...
                          <span class="read">
                            <a class="btn btn-info" href="post.php?postid=<?php echo $value['id']?>">Read More</a>
                          </span>
                        </div>
                        </div>
                      </div>
                    ...
                    <!--Paganition-->
                      ...
                      <nav aria-label="Page navigation" class="pagination-arae">
                        <ul class="pagination">
                            ...
                            <?php }?>
                            <li><a href="index.php?page=<?php echo $total_page?>">Last Page</a></li>
                        </ul>
                      </nav>
